file(REMOVE_RECURSE "U:/DEV/cmake-os2/Tests/CMakeTests/uploads")

if(EXISTS "U:/DEV/cmake-os2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "U:/DEV/cmake-os2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "U:/DEV/cmake-os2/Tests/CMakeTests/uploads")

set(filename "U:/DEV/cmake-os2/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "U:/DEV/cmake-os2/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}U:/DEV/cmake-os2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "U:/DEV/cmake-os2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "U:/DEV/cmake-os2/Tests/CMakeTests/uploads/file2.png"
